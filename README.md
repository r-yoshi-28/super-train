# BERT(言語処理)関連
- [x] **An Analysis of French-Language Tweets About COVID-19 Vaccines: Supervised Learning Approach**  
...
---
- [x] **COVID-19 patients classification using Graph neural network on a Heterogeneous graph**  
...
---
- [x] **Heterogeneous Graph Attention Network**  
...
---
- [x] **Heterogeneous Graph Transformer**  
